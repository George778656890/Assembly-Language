;Lab Assignment 6---Part2
;Author:Zhihong  Liu(5088806)
;31/10/2024
;Shift an array to the right side by user specified position  using pointer method
...
display PROC
;Goal:  Print the content of an array using pointer method
...
mov eax,TYPE sorted
mul ebx      
add esi,ebx  ;Now the ESI holds the sub-right-most pointer address
...
mov eax,DWORD PTR [esi]  ;Shift routine
mov [edi],al
...
main PROC
mov esi,offset sorted      ;Pass the pointer(array address) to the ESI which is the parameter of the procedure
mov ecx,LENGTHOF sorted   ; Pass the loop iteration numbers
